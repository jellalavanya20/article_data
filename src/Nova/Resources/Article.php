...
namespace Newindianic\ArticleData\Nova;
...
class Article extends Resource
{
     ...
     *
     * @var class-string<\Newindianic\ArticleData\Models\Article>
     */
    public static $model = \Newindianic\ArticleData\Models\Article::class;
